...
The average number of push-ups that a line player can do is about one third the amount of an average skilled player.

## Inferential Results

<!--State, hypothesis clearly. Make sure your discussion of the inferential test covers all the aspects that the test output produces, such as test statistic, p-value etc. Make a decision about the null hypothesis, explain the assumptions on which the selected test/procedure was based, and why the chosen procedure satisfies assumptions and is appropriate to answer the research question!-->
...
The p-value is far smaller than 0.5 indicated that there is a strong statistical significance.
